...
namespace LibraryAPI.Controllers.V2
{
    ...
    public class AuthorsController: ControllerBase
    {
        ...
        public async Task<ActionResult<AuthorWithBooksResponse>> GetById(
            ...
            [Description("Flag to know if the request has to include author books or not")] 
            bool includeBooks = false)
        {
            ...
            return Ok(_mapper.Map<AuthorWithBooksResponse>(author));
        ...
        public async Task<ActionResult<AuthorResponse>> Create([FromBody] AuthorRequest request)
        {
            ...
            return CreatedAtRoute("GetAuthorV2", new {id = entity.Id}, _mapper.Map<AuthorResponse>(entity));
        }
